...
from color_cube_model_building import *

class color_cube_training(object):
    def __init__(self, model_type):
        
        self.number_classes = 3
        self.model_type = str(model_type)

        color_cube_building_obj = color_cube_building(model_type = self.model_type)
        self.model = color_cube_building_obj.get_model()

        xy_data = color_cube_building_obj.get_data()
        ...
        self.batch_size = [10, 20, 30, 60, 80, 100]
        self.epochs = [1, 5, 10, 40, 100, 200]
        ...
        # Model
        self.model_categories = color_cube_building_obj.get_categories()
    ...
    def train_model(self):
        ...
        self.color_cube_model = self.model.fit(self.X_train, self.Y_train,
        ...
        self.model.save_weights("models/" + self.model_type + "_color_cube_categories_"+ str(self.number_classes)+"_model.h5")
    ...
    def evaluate_model(self):
        ...
        with open("graph_charts/" + self.model_type + "_evaluate_color_cube_category_" + str(self.number_classes) + ".txt", 'w') as write:
    ...
    def plot_model(self):
        ...
        plt.plot(self.color_cube_model.history['accuracy'])
        plt.plot(self.color_cube_model.history['val_accuracy'])
        ...
        plt.plot(self.color_cube_model.history['loss'])
        plt.plot(self.color_cube_model.history['val_loss'])
