...
class color_cube_building(object):
    ...
    def __init__(self, model_type):
        ...
        self.image_size = 240
        self.path = "Data/"
        self.true_path  = "color_cube_datasets/color_cubes/"
        self.valid_images = [".jpg",".png"]
        self.input_shape = None
        self.advanced_categories = ["green_cubes", "yellow_cubes", "red_cubes"]
    ...
    def resize_image_and_label_image(self, input_file):
        for image in os.listdir(self.true_path + input_file):
            ...
            if input_file == "green_cubes":
                self.label_name.append(0)
            elif input_file == "yellow_cubes":
                self.label_name.append(1)
            elif input_file == "red_cubes":
